...
/*
  Generated class for the PhotocommentsocialPage page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  templateUrl: 'build/pages/photocommentsocial/photocommentsocial.html',
})
export class PhotocommentsocialPage {
  public  items;
